...
setup(
  name = 'bin_by_mean',         # How you named your package folder (MyLib)
  packages = ['bin_by_mean'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/sonugopal/binbymean/archive/0.2.tar.gz',    # I explain this later on
